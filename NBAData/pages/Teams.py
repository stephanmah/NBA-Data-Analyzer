...
with st.container(border=True): 
    ...
    basic_stats_teams_table = st.dataframe(basic_team_stats_df, hide_index=True, use_container_width=True,
                           column_order=(
                               "SEASON_YEAR",  "TEAM_CONFERENCE", "TEAM_DIVISION", "W",   "L",    "PCT",  "CONF_RANK",  "DIV_RANK", "MIN_YEAR"),

                           column_config=({"SEASON_YEAR": "Season", "TEAM_CONFERENCE": "Conference", "TEAM_DIVISION": "Division",
                                           "W": "Wins",   "L": "Losses",    "PCT": "Win %",  "CONF_RANK": "Conference Rank",  "DIV_RANK": "Division Rank", "MIN_YEAR": "First Season"}))
